    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SentimentDetails", x => x.ID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID = table.Column<long>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    EntityText = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                name: "TweetKeyPhrases",
                columns: table => new
                {
                    ID = table.Column<long>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TweetID = table.Column<long>(nullable: false),
                    KeyPhrase = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TweetKeyPhrases", x => x.ID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TweetedBy = table.Column<long>(nullable: false),
                    TweetedOn = table.Column<DateTime>(nullable: false),
                    TweetID = table.Column<long>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TweetSentiments", x => x.ID);
                });
